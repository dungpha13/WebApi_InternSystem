    ...
    public partial class Test : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cauhoiCongnghes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_cauhoiCongnghes_cauhois_IdCauhoi",
                        column: x => x.IdCauhoi,
                        principalSchema: "dbo",
                        principalTable: "cauhois",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_cauhoiCongnghes_CongNghe_IdCongNghe",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cauhoiCongnghes_IdCauhoi",
                schema: "dbo",
                table: "cauhoiCongnghes",
                column: "IdCauhoi");

            migrationBuilder.CreateIndex(
                name: "IX_cauhoiCongnghes_IdCongNghe",
                schema: "dbo",
                table: "cauhoiCongnghes",
                column: "IdCongNghe");
