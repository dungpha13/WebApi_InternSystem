...
namespace AmazingTech.InternSystem.Services
{
    public interface IGuiLichPhongVanService
    {
        ...
        public bool SendResultInterviewEmail(string id);
    ...
    public class LichPhongVanService : IGuiLichPhongVanService
    {
        ...
        public bool SendResultInterviewEmail(string email)
        {
            ...
            string context = "Chào bạn ứng viên,<br>Đại diện bộ phận Nhân sự (HR) tại Công Ty TNHH Giải Pháp và Công nghệ Amazing, chúng tôi rất hân hạnh khi bạn đã quyết định tham gia chương trình thực tập tại Công ty của chúng tôi." +
                    "<br>Đây là kết quả sau buổi phỏng vấn của bạn: ĐẠT YÊU CẦU THAM GIA THỰC TẬP<br>" +
                    "A. THÔNG TIN VỀ KỲ THỰC TẬP:<br>" +
                    "\t 1. Hình thức thực tập: Linh động giữa Online và Offline<br>" +
                    ...
                    "Lưu ý: Chúng tôi muốn bạn biết rằng vị trí bạn mong muốn ban đầu và vị trí bạn thực tập không cố định, có thể được điều chỉnh dựa trên năng lực của bạn và yêu cầu dự án của công ty trong quá trình thực tập. <br>" +
                    "Chúng tôi tin rằng bạn sẽ mang đến một giá trị đặc biệt cho công ty của chúng tôi và hy vọng rằng bạn sẽ có một trải nghiệm thực tập thú vị, bổ ích tại Amazing Tech.<br>" +
                    "Trân trọng.<br>" +
